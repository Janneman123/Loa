...
public static String PossibleMoves(String[][] index3,String[][] board3,int size,String direction,int jumps,String startingposition,String endposition,String[] direction_of_movement, int pcjumps){
