...
public class PCDirection2{

public static String PCDirection2(String[][] index3,String[][] board3,int size,String[] direction_of_movement,String pcstartingposition){
