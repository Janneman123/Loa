...
public static String PossibleMoves(String[][] index3,String[][] board3,int size,String[] direction_of_movement){

		String[] moves={"left","right","up","down","downleft","downright","upleft","upright"};	
